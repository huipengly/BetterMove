...
HRESULT CGivePosition::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	...
	//	if (10 <= time)
	//	{
	//		//10.5, 9.5, 9.6, 9.9, 10.9
	//		MyCppPosition[PositionArraySize] = 10.5;
	//		PositionArraySize++;
	//		MyCppPosition[PositionArraySize] = 9.5;
	//		PositionArraySize++;
	//		MyCppPosition[PositionArraySize] = 9.6;
	//		PositionArraySize++;
	//		MyCppPosition[PositionArraySize] = 9.9;
	//		PositionArraySize++;
	//		MyCppPosition[PositionArraySize] = 10.9;
	//		PositionArraySize++;
	//	}
	//}
	//if ((5 == PositionCount) && (5 == PositionArraySize))
	//{
	//	time += 0.01;
	//	if (5 <= time)
	//	{
